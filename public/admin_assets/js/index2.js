...
var options = {
	...
	fill: {
        ...
        gradient: {
          ...
          type: "vertical",
          shadeIntensity: 0.5,
          gradientToColors: ["#ff6632", "#8ea8fd", "#c1cfff"],
          inverseColors: true,
          opacityFrom: 1,
          opacityTo: 1,
          //stops: [0, 50, 100],
...
new Chart(document.getElementById("chart6"), {
	...
	data: {
		...
		datasets: [{
			label: "Device Users",
			backgroundColor: ["#8ea8fd", "#ff6632", "#c1cfff"],
			data: [2478, 5267, 1834]
		}]
	},
	options: {
...
var options = {
	...
	fill: {
        ...
        gradient: {
          ...
          type: "vertical",
          shadeIntensity: 0.5,
          gradientToColors: ["#ff6632", "#c1cfff"],
          inverseColors: true,
          opacityFrom: 1,
          opacityTo: 1,
          //stops: [0, 50, 100],
