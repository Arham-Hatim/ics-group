...
@section('title', 'Setting | ICS Group')
@section('meta_description', 'Manage setting page content, company details, easily from the ICS Group admin panel.')
...
@section('content')
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-4">
            <div class="breadcrumb-title pe-3">Setting Management</div>
            <div class="ps-3">
        ...
        <div class="row">
            <!-- Form for Setting Details -->
            <div class="col-12 col-lg-8">
                <form action="{{ route('admin.setting.update') }}" method="POST">
                    @csrf
                    <div class="card border-0 shadow-sm radius-10">
                        <div class="card-body p-4">
                            <h5 class="mb-4 fw-bold">Setting Details</h5>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="phone_question"
                                        ...
                                        value="{{ old('phone_question', $setting->phone_question ?? '') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="fax"
                                        ...
                                        value="{{ old('fax', $setting->fax ?? '') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="time" name="office_start"
                                            ...
                                            value="{{ old('office_start', isset($setting->office_hours) ? \Illuminate\Support\Carbon::parse(explode(' - ', $setting->office_hours)[0])->format('H:i') : '') }}"
                                            required>
                                        ...
                                        <input type="time" name="office_end"
                                            ...
                                            value="{{ old('office_end', isset($setting->office_hours) ? \Illuminate\Support\Carbon::parse(explode(' - ', $setting->office_hours)[1])->format('H:i') : '') }}"
                                            required>
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="copy_right"
                                        ...
                                        value="{{ old('copy_right', $setting->copy_right ?? '') }}" required>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="social_links[linkedin]" class="form-control radius-10"
                                        ...
                                        value="{{ old('social_links.linkedin', $setting->social_links['linkedin'] ?? '') }}">
                                </div>
                                <div class="col-md-6">
            ...
            <div class="col-12 col-lg-4">
                <form action="{{ route('admin.setting.logos') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card border-0 shadow-sm radius-10">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Upload colored logo (Recommended: 175x70px) (Max: 5MB)</small>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold">White Logo</label>
                                <div class="mb-3">
                                    @if(isset($setting->white_logo))
                                        <img src="{{ $setting->white_logo }}" alt="White Logo"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    @if(isset($setting->favicon))
                                        <img src="{{ $setting->favicon }}" alt="Favicon"
                                ...
                                <small class="text-muted">Upload browser favicon (Recommended: 32x32px) (Max: 2MB)</small>
                            </div>
