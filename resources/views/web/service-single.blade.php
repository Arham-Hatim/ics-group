...
@section('content')
    ...
    {{--<div class="breadcrumb-area text-center shadow dark text-light bg-cover"
        ...
        <div class="breadcrumb-area text-center shadow dark text-light bg-cover"
            style="background-image: url({{ asset('web_assets/ics-images/service/banner.jpg') }});">
            <div class="container">
                <div class="row">
                ...
                <div class="services-details-items">
                    <div class="row">
                        ...
                        <div class="col-lg-8 services-single-content">
                            ...
                            <img src="{{ asset('web_assets/ics-images/service/service-image.jpg') }}" alt="Thumb">
                            ...
                            <p>
                                ...
                                pain
                                and trouble that are bound to ensue cannot foresee. These cases are perfectly simple and
                                easy to
                                distinguish. In a free hour, when our power of choice is untrammelled data structures
                                manages
                                data in technology.
                            </p>
                            <div class="features">
                            ...
                            <p>
                                Nam libero tempore, cum soluta nobis est elig endi optio cumque nihil impedit quo minus id
                                quod
