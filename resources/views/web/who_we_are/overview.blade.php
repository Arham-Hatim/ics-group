...
@section('content')
    ...
    {{--<div class="breadcrumb-area text-center shadow dark text-light bg-cover"
        ...
        <div class="breadcrumb-area text-center shadow dark text-light bg-cover"
            style="background-image: url({{ asset('web_assets/ics-images/about/banner.jpg') }});">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row align-center">
                        <div class="col-lg-6">
                            <div class="thumb">
                                ...
                                <img src="{{ asset('web_assets/ics-images/about/founder.jpg') }}" alt="Thumb">
                        ...
                        <div class="col-lg-6 clients">
                            <div class="partner-carousel owl-carousel owl-theme text-center">
                                <div class="single-item">
                                    ...
                                    <a href="#"><img src="{{ asset('web_assets/ics-images/about/partner1.png') }}" alt="Clients"></a>
                                </div>
                                <div class="single-item">
                                    {{--<a href="#"><img src="{{ asset('web_assets/img/150x80.png') }}" alt="Clients"></a>--}}
                                    <a href="#"><img src="{{ asset('web_assets/ics-images/about/partner2.png') }}" alt="Clients"></a>
                                </div>
                                <div class="single-item">
                                    {{--<a href="#"><img src="{{ asset('web_assets/img/150x80.png') }}" alt="Clients"></a>--}}
                                    <a href="#"><img src="{{ asset('web_assets/ics-images/about/partner3.png') }}" alt="Clients"></a>
                                </div>
                                <div class="single-item">
                                    {{--<a href="#"><img src="{{ asset('web_assets/img/150x80.png') }}" alt="Clients"></a>--}}
                                    <a href="#"><img src="{{ asset('web_assets/ics-images/about/partner4.png') }}" alt="Clients"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/about/team1.jpg') }}" alt="Thumb">
                                    <div class="social">
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{  asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/about/team2.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{  asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/about/team3.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
