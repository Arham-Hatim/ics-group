                    ...
                    <div class="row">
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/team/team2.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/team/team3.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/team/team4.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/team/team5.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    {{--<img src="{{ asset('web_assets/img/800x900.png') }}" alt="Thumb">--}}
                                    <img src="{{ asset('web_assets/ics-images/team/team6.jpg') }}" alt="Thumb">
                                    <div class="social">
                                        <a href="#" class="share-icon facebook">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
